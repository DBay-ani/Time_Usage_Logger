...
tagsToAddGitHashTo={"logEntry"};
relativePathToFolderHousingLogFile="houseForLog";
logFileName="timeLog.xml";
pathToLogFile=relativePathToFolderHousingLogFile+ "/" + logFileName;
